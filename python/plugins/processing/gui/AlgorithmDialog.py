...
class AlgorithmDialog(AlgorithmDialogBase):
    ...
    def accept(self):
        ...
        try:
            ...
            objThread = QThread()
            algExecutor = AlgorithmExecutor(self.alg, self)
            algExecutor.moveToThread(objThread)
            algExecutor.onFinish.connect(self.algExecutorGetResult)
    ...
    def algExecutorGetResult(self, algExecutor):
        Processing.algExeResult = algExecutor.result
        algExecutor.finished.emit()
